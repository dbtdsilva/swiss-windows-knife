...
def panel(qtbot, fake_user_settings, silent_messagebox):
    from swiss_windows_knife.plugins.display_image_tuner.sun_location_panel import SunLocationConfigPanel
...
def test_apply_rejects_when_timezone_cannot_be_resolved(panel, fake_user_settings):
    ...
    with patch(
        'swiss_windows_knife.plugins.display_image_tuner.location_picker.coordinates_to_timezone',
        return_value=None,
    ):
